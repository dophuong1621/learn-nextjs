...
class FooterComponent extends Component {
    render() {
        return <>
            <footer className="bg-blackk text-center text-white ft">
                <section className="">
                    <div className="content-ft">
                        ...
                        <div className="col-lg-4 col-md-6 mb-4 mb-md-0 ft-t-2">
                            <h2 className="t1-ft2 fw-7">Về chúng tôi</h2>
                            <p className="t2-ft2 fw-5">Chúng tôi luôn lấy uy tín đặt trên hàng đầu đối với khách hàng, hy vọng chúng tôi
                        ...
                        <div className="col-lg-3 col-md-6 mb-4 mb-md-0 ft-t-3 fw-6">
                            <h5 className="t1-ft3">HIHAROBUX.COM</h5>
