...
export interface IBuyItemsProps {
}

export default function BuyItem(props: IBuyItemsProps) {
    return (
        <div>
                ...
                <div className="gc-8 gc-12i">
                    <div className="bg-box py-sm-3 px-125 w-100 br-025 p-05r">
                        <div className="mb-sm-3 mb-2 pb-2 border-bot-w">
                            <h2 className="fw-6 text-lg">Danh Sách Mua Vật Phẩm</h2>
                            <p className="text-sm">Lịch sử hòm vật phẩm mà bạn đã mua.</p>
                        </div>
                        <div>
